...
class Model_komponen extends CI_Model
{
	function Tampilkan_komponen()
	{
		...
		$query = "SELECT * from komponen INNER join suboutput on komponen.id_suboutput = suboutput.id_suboutput INNER JOIN divisi ON suboutput.nama_divisi = divisi.nama";
